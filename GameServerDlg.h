...
public:
	...
	void DeaFSoftServerSettings(); // DeaFSoft Files Defter Ayarlar Eklendi 01.01.2025
	...
	void DeaFSoftAutoOnlineCount(); // DeaFSoft Yeni Auto Online Count Eklendi 01.01.2025
	void DeaFSoftAddBotMiningStart(); // DeaFSoft Bot Mining Otomatik Baþladi Eklendi. 23.02.2025
	...
	// DeaFSoft WelcomeStatus Eklendi 01.01.2025
	std::string WelcomeNoticeYeni;
	uint8 WelcomeNoticeR, WelcomeNoticeG, WelcomeNoticeB;
	bool DeaFSoftWelcomeStatus;
	// DeaFSoft WelcomeStatus Eklendi The End 01.01.2025

	// DeaFSoft Files Defter Eklendi 01.01.2025
	...
	bool GiriþUserisOnlineNotice;
	bool GiriþGateZoneNotice;
	...
	uint32	KillGoldGift, KillCashGift, KillÝtemGift;
	uint16 KillCountGift, Kill50CountGift, Kill500CountGift;
	uint32	Kill50GoldGift, Kill50CashGift, Kill50ÝtemGift;
	uint32	Kill500GoldGift, Kill500CashGift, Kill500ÝtemGift;
	// DeaFSoft Files Defter Settings Eklendi The End 01.01.2025
	...
	void SendYesilNotice(CUser* pUser, std::string sHelpMessage); // DeaFSoft Offline Merchant için Eklendi 29.12.2024
	void SendRgbNotice(std::string Message, uint8 R, uint8 G, uint8 B); // DeaFSoft Logos Rgb Notice Eklendi 29.12.2024
