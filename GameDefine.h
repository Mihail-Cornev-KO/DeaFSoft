...
struct _SERVER_SETTING
{
	...
	uint8 DropNotice;
	uint8 UpgradeNotice;
	uint8 GmisOnlineNotice; // DeaFSoft GmisOnline ve GmisOffline Gm Giriş Logos Notice Ayarlar Eklendi 30.12.2024
	uint8 OyunUserBotOnlineNotice; // DeaFSoft User&Bot Oyunda Online | Tablo Server_Settings OyunUserBotOnlineNotice Eklendi 1 Açip ve 0 Kapatma Ayarlar 30.12.2024
	uint8 MerchantView;
	uint8 UserMaxUpgradeCount;
	uint8 AutoQuestSkill;
	uint8 AutoUpFasterKatlama;
	uint8 ClanBankWithPremium; //DeaFSoft Clan Bankası Premiumlu veya Premiumsuz Acilsin 15.07.2020
	uint8 AutoRoyalG1; //DeaFSoft 15.08.2020
	uint8 LootandGeniePremium; //DeaFSoft 15.08.2020
	uint8 TradeLevel; //DeaFSoft 15.08.2020
	uint8 MerchantLevel; //DeaFSoft 15.08.2020
	...
	void Initialize()
	{
		...
		DropNotice = 0;
		UpgradeNotice = 0;
		GmisOnlineNotice = 0; //DeaFSoft GmisOnline ve GmisOffline Gm Giriş Logos Notice Ayarlar Eklendi 30.12.2024 
		OyunUserBotOnlineNotice = 0; //DeaFSoft User&Bot Oyunda Online | Tablo Server_Settings OyunUserBotOnlineNotice Eklendi 1 Açip ve 0 Kapatma Ayarlar 30.12.2024
