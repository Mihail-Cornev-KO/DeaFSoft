...
void CUser::GivePremium(uint8 bPremiumType, uint16 sPremiumTime, bool minute)
{
	...
	// DeaFSoft Premium Notice Eklendi 01.01.2025
	...
	//Disconnect(); //DeaFSoft Premium Yukeyince Dc etme Kapatildi 17.12.2020

	//DeaFSoft pre yükletince dc etmeden yenile karakteri işi garantiye aldık 
...
void CUser::GiveSwitchPremium(uint8 bPremiumType, uint16 sPremiumTime)
{
	...
	// DeaFSoft SWITCH Premium Notice Eklendi 01.01.2025
...
void CUser::GiveClanPremium(uint8 bPremiumType, uint32 sPremiumDay)
{
	...
	// DeaFSoft CLAN Premium Notice Eklendi 01.01.2025
