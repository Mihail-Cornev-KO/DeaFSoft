...
#pragma endregion
	...
	void UpdateKingList(std::string& strCharID, uint8 Nation); // DeaFSoft Auto King Name Update Eklendi 01.01.2025
	void LoadDeaFSoftWelcomeLogosNotice(); // DeaFSoft Welcome Logos Notice Eklendi 01.01.2025
