...
//	std::cout << "                               ************************************************" << std::endl;
//	std::cout << "                               *                                              *" << std::endl;
//	std::cout << "                               *                 SERVER AÇILDI                *" << std::endl;
//	std::cout << "                               *                                              *" << std::endl;
//	std::cout << "                               *                                              *" << std::endl;
//	std::cout << "                               *                                              *" << std::endl;
//	std::cout << "                               *				                                *" << std::endl;
...
bool CGameServerDlg::Startup()
{
	...
	m_HardwareIDArray.push_back(6483729541);
	...
	GetTimeFromIni();
	GetEventAwardsIni();
	DeaFSoftServerSettings(); // DeaFSoft Files x64 DeaFSoftSettings.ini Ayarlar Eklendi 01.01.2025 
	...
	g_DBAgent.LoadDeaFSoftWelcomeLogosNotice(); // DeaFSoft Welcome Logos Notice Eklendi 01.01.2025
	CreateDirectories();
	...
	ResetBeefEvent();
	EventTimerSet();
	DeaFSoftAddBotMiningStart(); // DeaFSoft Bot Mining Otomatik Başladi Eklendi. 23.02.2025
...
uint32 CGameServerDlg::Timer_CheckGameEvents(void* lpParam)
{
	while (true)
	{
		...
		g_pMain->DeaFSoftAutoOnlineCount(); // DeaFSoft Yeni Auto Online Count Notice Eklendi 01.01.2025
...
void CGameServerDlg::SendYesilNotice(CUser* pUser, std::string sHelpMessage) // DeaFSoft Offline Merchant için Eklendi 29.12.2024
{
...
void CGameServerDlg::SendRgbNotice(std::string Message, uint8 R, uint8 G, uint8 B) // DeaFSoft Logos Rgb Notice Eklendi 29.12.2024
{
	// DeaFSoft Logos Notice Eklendi. 29.12.2024
	...
	// DeaFSoft Logos Notice The End. 29.12.2024
}

// DeaFSoft WelcomeLogos Notice Eklendi. 01.01.2025
#pragma region CUser::WelcomeLogos(std::string LogosName, std::string LogosMessage, uint8 R, uint8 G, uint8 B)
void CUser::DeaFSoftWelcomeLogos(std::string LogosName, std::string LogosMessage, uint8 R, uint8 G, uint8 B)
{
	// DeaFSoft WelcomeLogos Notice Eklendi. 01.01.2025
	Packet result(WIZ_LOGOSSHOUT);
	std::string DeaFSoft = string_format(" : %s", LogosMessage.c_str());
	result.SByte();
	result << uint8(2) << uint8(1) << R << G << B << uint8(0) << DeaFSoft;
	Send(&result);
	// DeaFSoft WelcomeLogos Notice The End. 01.01.2025
}
#pragma endregion
...
void CGameServerDlg::DeaFSoftAddBotMiningStart()
{
