...
public:
	...
	void PlayerEffect(uint16 sEffect); // giriþ efect eklendi DeaFSezo
	...
	// DeaFSoft GM Full Upgrade %100 Özel Eklendi 05.01.2025
	bool GMUpgradeThis;
...
public:
	...
	*/
	...
	COMMAND_HANDLER(ClanChatFollowCommand); // DeaFSoft GameMaster Klan Sohbetini Oku Eklendi 01.01.2025
	COMMAND_HANDLER(FullUpgradeStatusHandlers); // DeaFSoft GM Full Upgrade %100 Özel Eklendi 05.01.2025
	...
	void DeaFSoftAutoLooter(_LOOT_BUNDLE* pBundle);
	...
	// DeaFSoft Settings Eklendi 30.12.2024
	void DeaFSoftGmisOnlineNotice();
	void DeaFSoftGmisOfflineNotice();
	void DeaFSoftOyunOnlineNotice();
	void DeaFSoftLoginUserisOnlineNotice();
	void DeaFSoftSendInfoNotice();
	void DeaFSoftGmInfoKomutNotice();
	void DeaFSoftUserGameInfoNotice();
	void DeaFSoftGateZoneNotice();
	void DeaFSoftExprationItemList();
	void DeaFSoftExprationItemDeleted();
	void DeaFSoftWelcomeLogos(std::string LogosName, std::string LogosMessage, uint8 R, uint8 G, uint8 B);
	// DeaFSoft Settings Eklendi The End 30.12.2024
