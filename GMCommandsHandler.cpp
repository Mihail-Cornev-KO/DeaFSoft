...
COMMAND_HANDLER(CUser::HandleOnlineGiveItemCommand)
{
	...
	// DeaFSoft Letter Online İtem Notice Eklendi. 31.01.2025
	...
	// DeaFSoft Letter Online İtem Notice Eklendi. The End 31.01.2025
...
COMMAND_HANDLER(CUser::HandleGiveItemSelfCommand)
{
	...
	// DeaFSoft GM İtem Notice Eklendi. 13.01.2025
...
{
	// DeaFSoft isKing Komut Eklendi 02.01.2025
	if (!isKing() && !isGM())
		return false;
